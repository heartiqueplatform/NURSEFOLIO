...
export const Sidebar: React.FC = () => {
  ...
  return (
    ...
    <aside className={`transition-all duration-300 sticky top-0 h-screen overflow-hidden ${isCollapsed ? 'w-20' : 'w-64'} bg-white dark:bg-slate-900 text-slate-900 dark:text-white flex flex-col justify-between border-r border-slate-200 dark:border-slate-800 p-4 hidden lg:flex flex-shrink-0`}>

      <button
        onClick={toggleCollapse}
        className="absolute -right-3 top-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-50 dark:hover:bg-slate-800 p-1.5 rounded-full shadow-md cursor-pointer z-50 flex items-center justify-center transition"
      >
