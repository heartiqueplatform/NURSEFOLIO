      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <button
            id="btn-print-legal"
            onClick={handlePrint}
            className="flex items-center gap-2 px-4 py-2 border border-slate-200 hover:border-slate-350 bg-white hover:bg-slate-50 text-slate-700 font-semibold text-xs rounded-xl shadow-sm cursor-pointer transition-all duration-150"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 flex flex-row lg:flex-col gap-2 overflow-x-auto pb-4 lg:pb-0 scrollbar-none">
            <button
              ...
              className={`flex items-center gap-2.5 px-4 py-3 text-left rounded-xl text-xs font-bold transition-all duration-150 whitespace-nowrap cursor-pointer flex-shrink-0 w-full ${
                activeTab === 'privacy'
                  ? 'bg-indigo-600 text-white shadow-md shadow-indigo-600/10'
                  : 'bg-white text-slate-650 hover:bg-slate-100/70 border border-slate-200/50'
              }`}
            >
          ...
          <div className="lg:col-span-3 bg-white border border-slate-200/70 rounded-2xl shadow-sm p-6 sm:p-10">
            
            {/* TAB 1: PRIVACY POLICY */}
            {activeTab === 'privacy' && (
              <div className="space-y-6">
                <div className="border-b border-slate-100 pb-5">
                  <div className="flex items-center gap-2 text-indigo-650 mb-1.5 font-bold text-xs uppercase tracking-wider">
                    <Shield className="w-4 h-4" />
                    <span>App Store Guidelines 5.1 & GDPR Compliant</span>
                  </div>
                  <h2 className="text-xl font-bold font-display text-slate-900 tracking-tight">Privacy Policy</h2>
                  <p className="text-xs text-slate-400 mt-0.5">Last Updated: May 25, 2026. Version 1.2.0</p>
                </div>
                ...
                <div className="text-sm text-slate-600 leading-relaxed space-y-4">
                  ...
                  <h3 className="text-sm font-bold text-slate-900 mt-6 uppercase tracking-wider flex items-center gap-1.5">
                  ...
                  <div className="bg-rose-50 border border-rose-100 p-4 rounded-xl text-rose-950 flex flex-col sm:flex-row gap-3">
                  ...
                  <div className="pt-4 border-t border-slate-100 text-xs text-slate-400 mt-6 text-center">
                    Questions about data processing may be referred to <strong className="text-slate-600">brianmuthomi851@gmail.com</strong>, designated representative for privacy affairs.
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === 'terms' && (
              <div className="space-y-6">
                <div className="border-b border-slate-100 pb-5">
                  ...
                  <h2 className="text-xl font-bold font-display text-slate-900 tracking-tight">Terms of Service</h2>
                  <p className="text-xs text-slate-400 mt-0.5">Last Updated: May 25, 2026</p>
                </div>
                ...
                <div className="text-sm text-slate-600 leading-relaxed space-y-4">
                  ...
                  <div className="bg-amber-50 border border-amber-100 p-5 rounded-xl text-slate-800">
                    <div className="flex items-start gap-3">
                      <div className="p-1 outline outline-amber-200 outline-offset-1 bg-amber-500 text-white rounded-lg flex-shrink-0">
                        <BadgeAlert className="w-4 h-4" />
                      </div>
                      <div className="text-xs md:text-sm">
                        <p className="font-bold text-slate-900 uppercase tracking-tight text-[11px] mb-1">
                        ...
                        <ul className="list-disc pl-4 space-y-1 mt-1.5 text-slate-650">
            ...
            {activeTab === 'compliance' && (
              <div className="space-y-6">
                <div className="border-b border-slate-100 pb-5">
                  <div className="flex items-center gap-2 text-indigo-650 mb-1.5 font-bold text-xs uppercase tracking-wider">
                    <Scale className="w-4 h-4" />
                    <span>Regional African Frameworks & App Store Conformity</span>
                  </div>
                  <h2 className="text-xl font-bold font-display text-slate-900 tracking-tight">Compliance & Regional Standards</h2>
                  <p className="text-xs text-slate-400 mt-0.5">Focus: NCK Portal, Kenya DPA 2019, Apple Guideline 5.1</p>
                </div>

                <div className="text-sm text-slate-600 leading-relaxed space-y-4">
                  
                  {/* African Regional Card (Kenya DPA 2019) */}
                  <div className="bg-slate-50 p-5 rounded-2xl border border-slate-150 space-y-3.5">
                    <div className="flex items-center gap-2 text-indigo-700">
                      <Map className="w-4 h-4 flex-shrink-0" />
                      <span className="font-bold text-xs uppercase tracking-wider">
                        Kenya Regional Healthcare Regulations Map
                      </span>
                    </div>
                    ...
                    <div className="space-y-3 text-xs md:text-sm">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 pt-1.5">
                        <div className="bg-white p-3.5 rounded-xl border border-slate-100 shadow-sm space-y-1">
                          <div className="flex items-center gap-1 text-teal-600 text-xs font-bold uppercase">
                      ...
                      <div className="p-3 bg-indigo-50/50 rounded-xl border border-indigo-100 text-[11px] text-indigo-950 flex gap-2">
                        <FileCheck className="w-4 h-4 text-indigo-600 flex-shrink-0 mt-0.5" />
                        <div>
                  ...
                  <div className="space-y-3 pt-2">
                    <div className="flex items-start gap-3 p-3 bg-white border border-slate-150 rounded-xl">
                      <CheckSquare className="w-4 h-4 text-emerald-600 mt-1 flex-shrink-0" />
                      <div>
                        <strong className="text-xs text-slate-900 uppercase">Guideline 5.1.1(a)(i) - Account Creation Disclosures</strong>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white border border-slate-150 rounded-xl">
                      <CheckSquare className="w-4 h-4 text-emerald-600 mt-1 flex-shrink-0" />
                      <div>
                        <strong className="text-xs text-slate-900 uppercase">Guideline 5.1.1(b)(ii) - Explicit Account Deletion Button</strong>
                        <p className="text-slate-500 text-xs mt-0.5">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white border border-slate-150 rounded-xl">
                      <CheckSquare className="w-4 h-4 text-emerald-600 mt-1 flex-shrink-0" />
                      <div>
                        <strong className="text-xs text-slate-900 uppercase">Guideline 5.1.1(b)(vii) - Medical Professional Verification Safety</strong>
                        <p className="text-slate-500 text-xs mt-0.5">
                  ...
                  <div className="bg-slate-100 p-3 rounded-xl font-mono text-xs text-slate-650 space-y-1">
                    <p>📧 Email: brianmuthomi851@gmail.com</p>
            ...
            <div className="hidden print:block pt-8 border-t border-slate-200 text-center text-xs text-slate-400 mt-12">
