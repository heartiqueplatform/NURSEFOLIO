    ...
    <div className="bg-slate-50/40 min-h-screen py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <span className="text-xs bg-indigo-50 border border-indigo-155 text-indigo-700 font-bold px-3 py-1 rounded-full uppercase tracking-wider font-mono">
            Verified Professional Credential Systems
          </span>
          <h1 className="text-4xl font-extrabold font-display tracking-tight text-slate-900 leading-[1.12]">
        ...
        <div className="bg-slate-900 rounded-[32px] p-8 md:p-12 mb-16 relative overflow-hidden text-white shadow-xl border border-slate-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-5 flex justify-center">
              <div className="bg-slate-800/60 backdrop-blur-md rounded-2xl border border-slate-700/60 p-6 w-full max-w-xs space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-xs font-semibold">
                    ...
                    <span className="text-amber-405">COMPILING...</span>
                  </div>
                  <div className="h-1.5 bg-slate-700 rounded-full overflow-hidden">
        ...
        <div className="space-y-8 mb-16">
          <h3 className="text-2xl font-bold font-sans text-slate-900 border-b border-slate-200/60 pb-4">What documentation is required?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {requirements.map((item, index) => {
              const Icon = item.icon;
              return (
                <div key={index} className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm space-y-4">
        ...
        {/* FAQs */}
        <div className="bg-white rounded-3xl border border-slate-100 p-8 sm:p-12 mb-16 space-y-8 shadow-sm">
          <h3 className="text-2xl font-bold font-sans text-slate-900">Verification Frequently Asked Questions</h3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm">
            <div className="space-y-2">
              <h4 className="font-bold text-slate-800">How long does my verification request take to resolve?</h4>
            ...
            <div className="space-y-2">
              <h4 className="font-bold text-slate-800">Is uploading sensitive IDs secure?</h4>
              <p className="text-slate-550 leading-relaxed">
            ...
            <div className="space-y-2">
              <h4 className="font-bold text-slate-800">Does verification cost money?</h4>
              <p className="text-slate-550 leading-relaxed">
            ...
            <div className="space-y-2">
              <h4 className="font-bold text-slate-800 font-sans">Can I reapply if my check gets declined?</h4>
              <p className="text-slate-550 leading-relaxed">
        ...
        {/* CTA */}
        <div className="text-center p-8 bg-indigo-50/50 border border-indigo-100 rounded-[24px] max-w-xl mx-auto space-y-4">
          <h4 className="text-xl font-bold font-display text-slate-850">Ready to boost your credentials?</h4>
