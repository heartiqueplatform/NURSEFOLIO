...
import { 
  ...
  Palette, Smartphone, ArrowRight, HeartHandshake, GraduationCap, LogIn
} from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="bg-white overflow-hidden">
      {/* Hero Section */}
      <div className="relative pt-10 pb-20 sm:pb-24 lg:pt-16 lg:pb-32 bg-gradient-to-br from-indigo-50/30 via-white to-indigo-50/10">
        
        {/* Soft floating background orb */}
        <div className="absolute top-20 right-1/4 w-96 h-96 bg-indigo-200/10 rounded-full blur-3xl -z-10 animate-pulse duration-[6000ms]"></div>
        <div className="absolute bottom-10 left-1/3 w-80 h-80 bg-indigo-100/10 rounded-full blur-3xl -z-10"></div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-7 lg:text-left">
              <motion.div 
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-50 text-indigo-750 text-xs font-semibold border border-indigo-100/50 mb-6"
              >
              ...
              >
                The premium portfolio and career space for <span className="text-indigo-600">Nurses</span>
              </motion.h1>
              ...
              <motion.p 
                ...
                className="mt-4 text-base sm:text-lg text-slate-500 leading-relaxed font-normal max-w-xl"
              >
              ...
              >
                <form onSubmit={handleSearchSubmit} className="relative flex items-center bg-white p-1.5 rounded-2xl border border-slate-200 shadow-sm focus-within:border-indigo-450 focus-within:ring-4 focus-within:ring-indigo-105/50 transition-all">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-transparent text-sm focus:outline-none text-slate-800"
                  />
                  <button
                    id="hero-submit-btn"
                    type="submit"
                ...
                <div className="mt-4 flex flex-wrap items-center gap-4 text-xs text-slate-450 pl-2">
                  <span className="font-semibold">Popular Specialties:</span>
                  <Link to="/explore?specialty=Intensive%20Care" className="hover:text-indigo-600 underline">Critical Care</Link>
                  <Link to="/explore?specialty=Pediatrics" className="hover:text-indigo-600 underline">Pediatrics</Link>
                  <Link to="/explore?specialty=Gerontology" className="hover:text-indigo-600 underline">Geriatrics</Link>
                </div>
              </motion.div>
            </div>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0 lg:col-span-5 flex justify-center">
              <motion.div 
                ...
                className="relative bg-slate-900 text-white rounded-3xl p-6 w-full max-w-sm shadow-2xl border border-slate-800"
              >
                ...
                <div className="absolute top-20 left-10">
                  <img
                    ...
                    className="w-16 h-16 rounded-2xl object-cover border-4 border-slate-900 shadow-lg"
                  />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    <span className="text-[10px] bg-slate-800 text-slate-300 font-medium px-2 py-0.5 rounded-full">Pediatrics</span>
                    <span className="text-[10px] bg-slate-800 text-slate-300 font-medium px-2 py-0.5 rounded-full">NICU Clinical</span>
                    <span className="text-[10px] bg-slate-800 text-slate-300 font-medium px-2 py-0.5 rounded-full">Ventilators</span>
                  </div>

                  {/* Highlight credential list */}
                  <div className="pt-4 border-t border-slate-850/80 mt-4 space-y-2 text-xs">
      ...
      <section className="py-16 sm:py-24 border-t border-slate-100 bg-slate-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold font-sans tracking-tight text-slate-900 sm:text-4xl">
              Professional features designed for digital medicine
            </h2>
            <p className="mt-2 text-base text-slate-550 leading-relaxed font-normal">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-slate-800 text-base mb-1">Board Verification</h3>
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-slate-800 text-base mb-1 font-sans">Multi-theme Portfolios</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-slate-800 text-base mb-1">Auto-generated CV</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-semibold text-slate-800 text-base mb-1">Android Ready</h3>
              <p className="text-sm text-slate-500 leading-relaxed">
      ...
      <section className="py-16 sm:py-20 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="p-8 rounded-[24px] bg-indigo-50/20 border border-indigo-100 flex flex-col justify-between h-full">
              <div>
                <HeartHandshake className="w-10 h-10 text-indigo-600 mb-6" />
                <h3 className="text-2xl font-display font-bold text-slate-900 mb-2">For Licensed Professionals</h3>
            ...
            {/* Students section */}
            <div className="p-8 rounded-[24px] bg-indigo-50/10 border border-slate-200/80 flex flex-col justify-between h-full">
              <div>
                <Activity className="w-10 h-10 text-indigo-455 mb-6" />
                <h3 className="text-2xl font-display font-bold text-slate-900 mb-2">For Nursing Students</h3>
                <p className="text-sm text-slate-550 leading-relaxed mb-6">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 text-sm font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 px-5 py-3 rounded-xl hover:shadow h-fit w-fit transition"
              >
        ...
        <div className="relative max-w-5xl mx-auto px-4 text-center sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
            ...
            <Link
              ...
              to="/explore"
              className="px-8 py-3.5 rounded-xl border border-slate-700 hover:bg-slate-800 text-slate-200 hover:text-white text-sm font-semibold transition"
            >
